    ...
    <div className="h-svh w-65 bg-[#0e0f10] fixed top-0 left-0 z-1000">
        <div className='ml-1 mt-10 mb-6 flex flex-row'>
          ...
          <div className='text-white'>
            <p>Trezor 5 Safe</p>
            <p className='flex flex-row items-center align-middle text-xs text-[#a29e9f]'><Link className='w-3 mr-1'/>Connected</p>
          </div>
        </div>
        <div className='border-b-2 border-[#252525]'>
          <ul class="list-none m-0 p-0 w-full">
              <li className="block text-white py-1.5 px-4 m-1 hover:cursor-pointer bg-[#171717] border-white/10 border rounded-xl"><i class="fa-regular fa-house mr-3"></i>Dashboard</li>
              <li className="block text-[#a29e9f] py-1.5 px-4 m-1 hover:cursor-pointer hover:text-white"><i class="fa-regular fa-bell mr-3"></i>Activity</li>
              <li className="flex text-[#a29e9f] py-1.5 px-4 m-1 hover:cursor-pointer hover:text-white"><Settings className='w-5 mr-3'/>Settings</li>
          </ul>
        </div>
        <div className='mt-5'>
